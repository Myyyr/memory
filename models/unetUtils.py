...
class Pad(nn.Module):
    ...
    def forward(self, outputs1, outputs2, padding):

        # print("#### WE'LL PAD ::", outputs1.shape, outputs2.shape)

        # outputs1 = F.pad(outputs1, padding)

        # print("#### WE PAD ::", outputs1.shape, outputs2.shape)
        ...
        # print("#### WE PADED ::", outputs1.shape, outputs2.shape)
...
class UnetUp3_CT(nn.Module):
    ...
    def forward(self, inputs1, inputs2):
        ...
        padding = 2 * [offset // 2, offset // 2, 0]
        # outputs1 = F.pad(inputs1, padding)
        outputs1, outputs2 = self.pad(inputs1, outputs2, padding)
